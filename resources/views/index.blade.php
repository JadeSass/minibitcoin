        ...
        <div id="app">
            ...
            <div class="use-timeline" id="mb-timeline">
                <div class="container">
                    ...
                    <div class="carousel">
                        <a class="carousel-item" href="https://t.me/De_ve_loper"><img src="{{asset('img/IMG-20210711-WA0016.jpg')}}"><b class="orange-text text-darken-3 text-center">Steve Dave ~ C.E.O <i class="fa fa-telegram"></i></b></a>
